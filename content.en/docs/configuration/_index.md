...
| [Raw JSON]({{< relref "/docs/configuration/raw-json" >}}) | `name` and complete user-owned Xray configuration | Connect → expert mode → Raw JSON → import or editor | Managed Tunnel, logs, metrics, DNS query policy and applicable interface |
