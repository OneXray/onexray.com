...
| Xray Profiles | Structured Xray-core configuration, including Simple Profile and advanced UI editing. |
...
The enhanced routing templates are no longer imported from inside the app. Use the [Routing]({{< relref path="../routing/index.md" lang="en" >}}) page to copy the current JSON templates into Xray Profiles.
