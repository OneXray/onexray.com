...
| Settings | Обновления, поведение при запуске, резервные копии, оформление, язык, поддержка, версии, лицензии и конфиденциальность. |
...
| macOS (Mac App Store) | macOS 13.0 и новее, Apple silicon или Intel | [App Store](https://apps.apple.com/us/app/onexray/id6745748773) |
| macOS (вне App Store) | macOS 13.0 и новее, Apple silicon или Intel | Homebrew: `brew install --cask onexrayse`, [Universal ZIP](https://github.com/OneXray/OneXray/releases/latest/download/OneXray-macos-universal.zip) |
