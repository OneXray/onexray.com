...
Редкие поля описаны в [справочнике Xray соответствующей версии](https://xtls.github.io/config/), который не отменяет границы приложения. Восстановление FakeDNS управляемым inbound имеет [отдельное ограничение версии]({{< relref "/docs/configuration/dns" >}}).
