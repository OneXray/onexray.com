...
## FakeDNS — только разработка

Подтвердите [совместимость]({{< relref "/docs/configuration/compatibility" >}}): это не база 26.9.2.
...
В проверенном Raw обнаруживается сервер fakedns или корневой пул, после чего tunIn получает восстановление. Пользовательские DNS и пулы не заменяются. Не ожидайте этой интеграции от старой сборки.
