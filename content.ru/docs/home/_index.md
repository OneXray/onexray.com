...
| Full Config | Structured local node with its own outbounds, routing, DNS and FakeDNS, based on the current Xray Profile at runtime. | Только группа Local на Home. |
