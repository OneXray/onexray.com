...
当开启该配置项时，系统会自动启动 VPN，无论是系统重新启动或 VPN 进程被杀死。
若您想关闭该选项，请在关闭该选项后重启一次 VPN，以使选项生效。

Android 系统的“始终开启”功能，需要您在系统设置中自行开启。由于每个品牌的固件不同，这里仅给出一个操作路径：
系统“设置” App ➡️ VPN（它可能在首页，网络或者共享中） ➡️ OneXray ➡️ 始终开启的 VPN。
